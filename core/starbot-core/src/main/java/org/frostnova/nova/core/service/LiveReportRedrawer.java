 ...
 * 从明细重画一场下播报告的扩展点
 * <p>
 * 控制台回看时按当场明细现画；明细是原始数据，永久留着。
 * 要看得到那张图，靠的就是这一支：<b>把明细喂回画报告的那套代码，重画一张</b>。
 * <p>
 * <b>为什么是扩展点而不是核心自己画</b>：报告长什么样是平台的事——
 * 哪几条曲线、哪几张榜、金额怎么写，核心一概不知道，它只知道「这一场的数据在这儿」。
 * 与 {@link org.frostnova.nova.core.analytics.LiveMetricCatalog} 同一条分工。
 * <p>
 * 没有对应平台的实现时，这一场就看不到报告图——<b>不会画错，只会没有</b>。
 */
