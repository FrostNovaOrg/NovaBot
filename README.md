...
```bash
./build.sh
docker build -f dist/templates/Dockerfile -t novabot:5.5.0 dist/build
docker run -d --name novabot --restart unless-stopped -v novabot-data:/app -p 127.0.0.1:7827:7827 novabot:5.5.0
```
