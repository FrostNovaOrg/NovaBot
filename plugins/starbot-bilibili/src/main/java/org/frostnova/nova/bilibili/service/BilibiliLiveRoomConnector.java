...
import org.frostnova.nova.bilibili.enums.DataHeaderType;
import org.frostnova.nova.bilibili.enums.DataPackType;
import org.frostnova.nova.bilibili.event.live.BilibiliConnectedEvent;
...
import org.frostnova.nova.bilibili.event.live.BilibiliDisconnectedEvent;
...
import org.frostnova.nova.bilibili.protocol.BilibiliPacket;
...
public class BilibiliLiveRoomConnector extends BinaryWebSocketHandler {
     ...
     * 未知协议版本记账：每条都计数。
     * <p>
     * 判定不在这里：是不是未知版本由 {@link org.frostnova.nova.bilibili.protocol.BilibiliPacketCodec}
