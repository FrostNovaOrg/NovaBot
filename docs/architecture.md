...
|---|---|---|---|
| 控制台页 | `config/ui/page/ConsolePageProvider` | `BilibiliConsolePageProvider` 与页面脚本 `config-ui-pages/bilibili.js`（starbot-bilibili） | 往控制台添自己的页；挂在连接页、设置页、顶级页还是首页卡由 `ConsolePageSlot` 申报 |
