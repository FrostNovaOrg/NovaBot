...
|---|---|---|---|
| 控制台页 | `config/ui/page/ConsolePageProvider` | `BilibiliConsolePageProvider` 与页面脚本 `config-ui-pages/bilibili.js`（starbot-bilibili） | 往控制台添自己的页；挂在连接页、设置页还是顶级页由 `ConsolePageSlot` 申报 |
